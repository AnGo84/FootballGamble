...
@Service("gambleCompetitionsService")
public class GambleCompetitionServiceImpl implements CommonService<GambleCompetition> {

	private static final String ENTITY_PATH = "/gamblecompetitions";

	public static final Logger logger = LoggerFactory.getLogger(GambleCompetitionServiceImpl.class);
	...
	@Override
	public List<GambleCompetition> findAll()
			throws AuthorisationException, NotFoundException, DataConflictException, RestAPIServerException {
		logger.info("Get All GambleCompetitions List");
		List<GambleCompetition> list = new ArrayList<>();

		RestTemplate restTemplate = new RestTemplate();
		restTemplate.setErrorHandler(new RestTemplateResponseErrorHandler());
		// Example: https://www.baeldung.com/spring-rest-template-list
		ResponseEntity<List<GambleCompetition>> response = restTemplate.exchange(apiPath + ENTITY_PATH, HttpMethod.GET,
				httpHeaders.getHttpAuthEntity(), new ParameterizedTypeReference<List<GambleCompetition>>() {
				});
	...
	@Override
	public GambleCompetition findById(long id)
			throws AuthorisationException, NotFoundException, DataConflictException, RestAPIServerException {
		/*
		 * logger.info("Get GambleUser by id: " + id); RestTemplate restTemplate = new
		 * RestTemplate(); restTemplate.setErrorHandler(new
		 * RestTemplateResponseErrorHandler()); ResponseEntity<GambleUser> response =
		 * restTemplate.exchange(apiPath + ENTITY_PATH + "/" + id, HttpMethod.GET,
		 * httpHeaders.getHttpAuthEntity(), GambleUser.class); GambleUser entity =
		 * response.getBody(); return entity;
		 */
		return null;
	}

	@Override
	public GambleCompetition findByName(String name) {
		/*
	...
	@Override
	public void save(GambleCompetition object)
			throws AuthorisationException, NotFoundException, DataConflictException, RestAPIServerException {
		/*
	...
	@Override
	public void update(GambleCompetition object)
			throws AuthorisationException, NotFoundException, DataConflictException, RestAPIServerException {
		/*
	...
	@Override
	public boolean isExist(GambleCompetition entity)
			throws AuthorisationException, NotFoundException, DataConflictException, RestAPIServerException {
		logger.info("is GambleCompetition Exist: " + entity);
